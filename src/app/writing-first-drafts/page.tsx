...
AI and I might both be learning something new here.`}</pre>
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6 my-8">
        ...
        <ul>
          <li className="mb-2">Session 1: <Link href="/blog/brainstorming" className="text-blue-600 dark:text-blue-400 hover:underline">Brainstorming Ideas for AI Safety Fiction</Link></li>
          <li>Session 2: <Link href="/blog/speedrun-story-outlines" className="text-blue-600 dark:text-blue-400 hover:underline">How to Speedrun Story Outlines for Envisioning Positive AI Safety Futures</Link></li>
        </ul>
      </div>
