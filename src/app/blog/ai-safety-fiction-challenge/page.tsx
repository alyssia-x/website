  ...
  return (
    ...
    >
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6 my-8">
        ...
        <p className="mb-4">
          This post inspired the Bluedot Impact AI Safety Fiction Writing Intensive (Jan 2025), where over a dozen AI Safety fiction stories were written in 5 days out over 40 applicants! Some will be published in <a href="https://flashfictionmagazine.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">Flash Fiction Magazine</a> later this year.
        </p>
        <p className="mb-4">
          We are now forming the AI Safety Fiction Collective - if you'd like me to customize or facilitate a version of this course for a group, run a contest, or inquire about joining our group, reach out to me <a href="mailto:alyssia.jovellanos@gmail.com" className="text-blue-600 dark:text-blue-400 hover:underline">here</a>. Check out parts of the curriculum I wrote <Link href="/blog/brainstorming-ai-safety-fiction" className="text-blue-600 dark:text-blue-400 hover:underline">here</Link>. For fun, I also made an <Link href="/prompts" className="text-blue-600 dark:text-blue-400 hover:underline">AI Safety Fiction Prompt Generator</Link> with a focus on envisioning positive futures!
        </p>
        <p>
