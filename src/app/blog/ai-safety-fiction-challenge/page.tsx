  ...
  return (
    ...
    >
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6 my-8">
        ...
        <p className="mb-4">
          This post inspired the funded Bluedot Impact Safety Fiction Writing Intensive (Jan 2025), where over a dozen stories were written from a pool of 40 applicants! Some were published in <a href="https://flashfictionmagazine.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">Flash Fiction Magazine</a>. Check out parts of the curriculum I wrote <Link href="/blog/brainstorming-ai-safety-fiction" className="text-blue-600 dark:text-blue-400 hover:underline">here</Link>. For fun, I also made an <Link href="/prompts" className="text-blue-600 dark:text-blue-400 hover:underline">AI Safety Fiction Prompt Generator</Link> with a focus on envisioning positive futures!
        </p>
        <p className="mb-4">
